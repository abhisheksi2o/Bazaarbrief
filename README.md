...
- `ROUTINE.md` – the prompt used by the scheduled Routines that refresh the desk.
...
- Weekdays at 07:00, 16:30 and 22:00 IST: morning brief, closing wrap, late edition.
